...
The data set we use in this project is the publicly available data from a research of my major.It is a survey over 200 adults and contains 14 variables.The main variables include "wage"( monthly earnings), "hour"(average weekly hours),"IQ"(IQ score), "exper"(years of work experience),"age"(age in years), "married"(=1 if married), "black"(=1 if black), etc.There are 92 observations for unmarried people, and 774 observations for married people;768 observations for non-black people, and 98 observations for black people.
...
data_wage %>% mutate(cluster = as.factor(wage_pam$clustering)) %>% 
    ggpairs(cols = 2:8, aes(color = cluster))
```
